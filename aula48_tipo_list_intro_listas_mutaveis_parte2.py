...
NO ÍNICIO OU NO FINAL DA LISTA, POIS DO CONTRÁRIO,
...
DEVIDO A AQUELA REMOÇÃO DAQUELE VALOR QUE FOI FEITA 
FORA DO INÍCIO OU DO FINAL DA LISTA. ISSO SE APLICA 
...
# Removendo valores no final da lista
lista2.pop()
